// components/SponsorChatClient.jsx
...
export default function SponsorChatClient({ apiKey = '' }) {
  // Use prop from server page (most reliable on Vercel). Optional window fallback.
